...
import com.example.lazabee.data.model.*;
import com.example.lazabee.data.model.auth.*;
...
public interface ApiService {
    ...
    @POST("api/cart")
    Call<ApiResponse<CartItem>> addToCart(
        @Query("productId") Long productId,
        @Query("quantity") int quantity
    );

    @PUT("api/cart/{cartItemId}")
    Call<ApiResponse<Void>> updateCartItem(
