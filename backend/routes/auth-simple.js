...
// Quên mật khẩu (phiên bản đơn giản - chỉ trả về mã cố định)
router.post('/forgot-password', async (req, res) => {
    try {
        ...
        // Tạo mã xác nhận cố định cho test
        ...
        res.json({
            success: true,
            message: 'Mã xác nhận là: 123456 (dành cho test)',
            code: verificationCode // Chỉ để test, production không nên trả về
        });
